...
export function Hero() {
  return (
    <section className="relative py-20 md:py-32 overflow-hidden">
      {/* Background pattern */}
      <div className="absolute inset-0 cell-pattern opacity-30" />
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            <Link
              href="/workspace"
              className="group px-8 py-4 bg-excel-green hover:bg-excel-darkgreen text-white rounded-xl font-semibold text-lg transition-all flex items-center space-x-2 excel-glow"
            >
          ...
          <div className="grid grid-cols-3 gap-8 max-w-2xl mx-auto">
            ...
            >
              <div className="text-3xl md:text-4xl font-bold text-excel-green mb-2">500+</div>
            ...
            <motion.div
              ...
              className="text-center"
            >
              <div className="text-3xl md:text-4xl font-bold text-excel-green mb-2">100+</div>
